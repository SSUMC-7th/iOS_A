...
class LoginView: UIView {
    ...
    public lazy var pwLabel: UILabel = {
        ...
        pwLabel.text = "비밀번호"
        pwLabel.font = UIFont.boldSystemFont(ofSize: 12)
    ...
    // 로그인 버튼 생성
    private func createLoginButton(title: String, imageName: String) -> UIButton {
        ...
        loginButton.setImage(UIImage(named: imageName), for: .normal) // 아이콘 설정
        loginButton.tintColor = .black
        loginButton.backgroundColor = .white
        loginButton.layer.cornerRadius = 10
        loginButton.layer.borderWidth = 1
        loginButton.layer.borderColor = UIColor(red: 217/255, green: 217/255, blue: 217/255, alpha: 1.0).cgColor
        loginButton.imageEdgeInsets = UIEdgeInsets(top: 0, left: -150, bottom: 0, right: 0) // 아이콘 위치 조정
    ...
    public lazy var kakaoLoginButton: UIButton = {
        return createLoginButton(title: "카카오로 로그인", imageName: "Kakao_logo")
    }()

    // Apple 로그인 버튼
    public lazy var appleLoginButton: UIButton = {
        return createLoginButton(title: "apple로 로그인", imageName: "Apple_logo")
    }()
