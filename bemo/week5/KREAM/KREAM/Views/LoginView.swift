...
class LoginView: UIView {
    ...
    public lazy var kakaoLoginButton: UIButton = {
        ...
        loginbtn.setImage(UIImage(named: "Kakao_logo"), for: .normal) // 카카오 아이콘 설정
        loginbtn.tintColor = .black // 이미지 색상 설정
        ...
        loginbtn.imageEdgeInsets = UIEdgeInsets(top: 0, left: -150, bottom: 0, right: 0) // 아이콘 위치
    ...
    public lazy var appleLoginButton: UIButton = {
        ...
        loginbtn.setAttributedTitle(title, for: .normal)
        loginbtn.setImage(UIImage(named: "Apple_logo"), for: .normal) // 카카오 아이콘 설정
        loginbtn.tintColor = .black // 이미지 색상 설정
        loginbtn.backgroundColor = .white
        // 모서리 둥글게
        loginbtn.layer.cornerRadius = 10
